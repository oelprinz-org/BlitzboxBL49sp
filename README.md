# blitzBOX - V0.1.6 - minor updates on power supply<br/>
<br/>
ultra-low-cost and mini-sized ECU for speeduino firmware (Rev0.1.6 45 x 58 mm)<br/>
...
06.05.2022: Final version is getting closer. Also added some information how to wire the connector (interactive page): http://oelprinz.org/products/BlitzboxBL49sp/documentation/V0.1.4/wiki/pinout_V0.1.4_Connector_top_side.html<br/>More information/documentation coming soon<br/>
...
<br/>
Quick link to Rev0.1.6 schematic: https://github.com/oelprinz-org/BlitzboxBL49sp/blob/master/hardware/Rev0.1.6/schematics_blitzbox_v0.1.6.pdf <br/>

Quick link to Rev0.1.6 iBOM: http://oelprinz.org/products/BlitzboxBL49sp/hardware/V0.1.6/iBOM/ibom.html <br/>

<p align="center">
  <br/>
  <img src="hardware/Rev0.1.6/2022-09-22-Board-Blitzbox-V0.1.3_top.png" width="710" alt="Board-Blitzbox-V0.1.3_top"><br/>
  <img src="hardware/Rev0.1.6/2022-09-22-Board-Blitzbox-V0.1.3_bottom.png" width="710" alt="Board-Blitzbox-V0.1.3_bottom"><br/>
  <img src="hardware/Rev0.1.6/2023-03-22-Board-Blitzbox-V0.1.6.png" width="710" alt="Board-Blitzbox-V0.1.6"><br/>
  <img src="hardware/Rev0.1.6/top.png" width="350" title="top">
  <img src="hardware/Rev0.1.6/bottom.png" width="350" alt="bottom"><br/>
  <img src="hardware/Rev0.1.6/internal_plane1.png" width="350" title="Internal Plane 1">
  <img src="hardware/Rev0.1.6/internal_plane2.png" width="350" title="Internal Plane 2">
  <img src="hardware/Rev0.1.6/top_layer.png" width="350" title="top_layer">
  <img src="hardware/Rev0.1.6/bottom_layer.png" width="350" alt="bottom_layer">
  <img src="hardware/Rev0.1.6/assembly_solderside_V0.1.6.png" width="710" alt="assembly_solderside"><br/>
  <img src="hardware/Rev0.1.6/assembly_connectorside_V0.1.6.png" width="710" alt="assembly_connectorside"><br/>
</p>
<br/>
<p align="center">
  <br/>
